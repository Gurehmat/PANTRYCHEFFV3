      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            >
              <Sparkles className="w-5 h-5" /> Home
            </Link>
            <Link
              to="/"
              onClick={closeMenu}
            ...
            >
              <Package className="w-5 h-5" /> My Pantry
            </Link>
            <Link
              to="/recipes"
              onClick={closeMenu}
            ...
            >
              <UtensilsCrossed className="w-5 h-5" /> Recipes
            </Link>
            <Link
              to="/generator"
              onClick={closeMenu}
            ...
            >
              <Sparkles className="w-5 h-5 text-yellow-500" /> Magic Recipe
            </Link>
            <Link
              to="/shopping-list"
              onClick={closeMenu}
